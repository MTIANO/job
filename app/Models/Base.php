...
class Base extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope('status',function (Builder $builder){
            $builder->where((new Base)->getTable().'.status','!=',self::STATUS_DISABLE);
        });
    }
    ...
    public function scopeStatus(Builder $query){
        return $query->where((new Base)->getTable().'.status','=', self::STATUS_ENABLE);
    }
    ...
    {
       return $query->where((new Base)->getTable().'.status', '=', self::STATUS_DISABLE);
    }
    ...
    {
        return $query->where((new Base)->getTable().'.status', self::STATUS_DELETED);
    }
    ...
    {
        return $query->where((new Base)->getTable().'.status', $status);
    }
